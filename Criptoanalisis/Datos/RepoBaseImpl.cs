...
namespace Datos
{
    public class RepoBaseImpl<Entidad,Contexto> : IRepoBase<Entidad, Contexto> where Entidad : class where Contexto : DbContext, new()
    {
        ...
        public IQueryable<Entidad> Get() => RepoContext.Set<Entidad>();
        /// <summary>
        ...
        public IQueryable<Entidad> GetBy(Expression<Func<Entidad, bool>> predicado) => RepoContext.Set<Entidad>().Where(predicado);
        /// <summary>
        ...
        public Entidad GetAtPos(int pos) => RepoContext.Set<Entidad>().ToList()[pos];
        /// <summary>
        ...
        public Entidad Create(Entidad entity) => Persist(() => RepoContext.Set<Entidad>().Add(entity));
        /// <summary>
        ...
        /// <exception cref="DbUpdateException"></exception>
        /// <exception cref="DbUpdateConcurrencyException"></exception>
        public Entidad Update(Entidad entity) => Persist(() => RepoContext.Set<Entidad>().Update(entity));
        /// <summary>
        ...
        /// <exception cref="DbUpdateException"></exception>
        /// <exception cref="DbUpdateConcurrencyException"></exception>
        public Entidad Delete(Entidad entity) => Persist(() => RepoContext.Set<Entidad>().Remove(entity));
        /// <summary>
        ...
        /// <exception cref="DbUpdateException"></exception>
        /// <exception cref="DbUpdateConcurrencyException"></exception>
        protected Entidad Persist(Func<EntityEntry<Entidad>> act)
        {
            var r = act.Invoke();
